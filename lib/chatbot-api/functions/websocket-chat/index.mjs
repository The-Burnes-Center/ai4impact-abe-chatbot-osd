 ...
 */
function snapToSentenceEnd(text, rawOffset) {
...
function insertCitationMarkers(text, citations, docIndexMap, allSources) {
  ...
  // Deduplicate: if same sentence end has multiple citations, group them
  // Sort descending by offset so earlier positions aren't shifted by insertions

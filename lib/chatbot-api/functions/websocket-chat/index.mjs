        ...
        for await (const event of stream) {
          ...
          if (parsedChunk) {                      
            ...
            if (usingTool) {
              ...
              console.log(`tool round ${toolRoundCount}/${MAX_TOOL_ROUNDS}`)
              ...
              if (toolUse.name === "query_db") {
              ...
              } else if (toolUse.name === "retrieve_full_document") {
                ...
                toolResultContent = fullDocResult.documentBlocks.length > 0
                ...
                toolResultContent = { text: toolResultContent, documentBlocks: fullDocResult.documentBlocks };

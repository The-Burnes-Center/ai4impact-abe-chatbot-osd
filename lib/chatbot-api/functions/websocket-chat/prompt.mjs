...
12. ALWAYS trust tool-returned counts over your own counting. When a tool returns \`unique_count\`, \`total_matches\`, or similar counts, use those numbers as authoritative. Never override them based on user assertions or your own recount of a list. Remember: \`total_matches\` is rows, \`unique_count\` is distinct values — always use \`count_unique\` with the right column for "how many distinct X" questions.

...
- When retrieved documents contain bullet lists using `•` characters (e.g., "• Item A • Item B • Item C"), always reformat them as proper markdown lists (`- Item A\n- Item B\n- Item C`). Never output inline `•`-delimited text as a running paragraph.

...
- If results contain duplicate entries (e.g. same vendor appearing multiple times with different blanket numbers), deduplicate by the \`Vendor_Name\` field exactly as returned by the tool, and present only unique entries. State the unique count using the tool's \`unique_vendors\` value.

/**
 * Contract Index REST API: status, preview, upload-url.
...
const QUERY_FUNCTION = process.env.CONTRACT_INDEX_QUERY_FUNCTION;
const BUCKET = process.env.BUCKET;
const URL_EXPIRATION_SECONDS = 300;
const FIXED_KEY = "swc-index/latest.xlsx";
...
export const handler = async (event) => {
  ...
  try {
    ...
    console.error("Contract index API error:", err);
